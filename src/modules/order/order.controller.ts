...
export class OrderController {
    ...
    runModuleCreate = catchAsync(async (req: Request, res: Response) => {
        ...
        const body = req.body as { items: Array<{ itemIndex: number; orderItemId?: string; serverId?: string; whmPackage?: string; username?: string; password?: string; registrar?: string; runModuleCreate?: boolean; sendWelcomeEmail?: boolean; allowUnpaidTrial?: boolean; trialDays?: number }> };
