...
export const PERMISSION_META: Record<string, PermissionMeta[]> = {
    ...
    domains: [
        ...
        { id: 'domains:adopt_existing', label: 'Assign existing registrar domain to client', category: 'infrastructure', riskLevel: 'medium' },
        { id: 'domains:sync_by_service', label: 'Sync domain by service', category: 'infrastructure' },
        { id: 'domains:status_update', label: 'Update domain lifecycle/status', category: 'infrastructure', riskLevel: 'medium' },
