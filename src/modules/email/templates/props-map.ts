...
import type { LateFeeAppliedProps } from './billing/late-fee-applied';
...
import type { UnsuspendedProps } from './service/unsuspended';
import type { ServiceRenewedProps } from './service/renewed';
...
import type { DomainRenewalSuccessProps } from './domain/renewal-success';
import type { DomainRenewalFailedProps } from './domain/renewal-failed';
...
export interface TemplatePropsMap {
    ...
    'billing.invoice_due_soon': OverdueReminderProps;
    'billing.invoice_due_today': OverdueReminderProps;
    'billing.invoice_overdue_first': OverdueReminderProps;
    'billing.invoice_overdue_second': OverdueReminderProps;
    'billing.invoice_overdue_final': OverdueReminderProps;
    'billing.payment_success': PaymentSuccessProps;
    'billing.payment_failed': PaymentFailedProps;
    'billing.late_fee_applied': LateFeeAppliedProps;
    ...
    'service.unsuspended': UnsuspendedProps;
    'service.renewed': ServiceRenewedProps;
    'domain.registration_confirmation': DomainRegistrationConfirmationProps;
    'domain.renewal_reminder': DomainRenewalReminderProps;
    'domain.renewal_success': DomainRenewalSuccessProps;
    'domain.renewal_failed': DomainRenewalFailedProps;
