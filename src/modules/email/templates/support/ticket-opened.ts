...
`;
    ...
    renderText: (props) =>
        htmlToPlainText(
            `Support ticket #${props.ticketId} received. Subject: ${props.ticketSubject}. Priority: ${props.priority}. Department: ${props.department}. Created: ${props.createdAt}.${props.summaryMessage ? ` ${props.summaryMessage}` : ''} View: ${props.ticketUrl}. Expected: A support agent will respond within 24 hours.`
        ),
};
